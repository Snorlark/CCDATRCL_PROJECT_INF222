...
public class SettingsController implements Initializable{
    ...
    public static String name = RegisterController.firstName + RegisterController.firstName;
    public static String contactNo = RegisterController.contactNo;
    public static String address = RegisterController.address;
    public static String email = RegisterController.address;
    public static String birthday = RegisterController.address;
